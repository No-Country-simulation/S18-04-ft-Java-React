...
INSERT INTO register_stack(event_record_id, framework_id) values ('b856b2a3-b0ad-403f-ac8e-0a9e1c7013bb','0945d50a-65d9-4e00-bdd4-ff20268455e9');
...
--     team_name_v TEXT;             -- Variable para almacenar el nombre del equipo
--     new_team_id UUID;
-- BEGIN
--     LOOP
--         -- Seleccionar los registros elegibles para actualizar
...
--         )
--         -- Actualizar los registros que cumplen con las condiciones
...
--         );
--         -- Construir el nombre del equipo dinámicamente después de actualizar number_team
--         SELECT CONCAT(ev.event_name, '-', e.number_team, '-', e.schedule, '-', f.framework_name,'-',l.language_name)
--         INTO    team_name_v
--         FROM event_records e
--                  left JOIN register_stack r
--                            ON e.event_record_id=r.event_record_id
--                  left JOIN events ev
--                            ON e.event_id = ev.event_id
--                  left JOIN frameworks f
--                            ON f.framework_id = r.framework_id
--                  left JOIN languages l
--                            ON e.language_id=l.language_id
--         LIMIT 1;
--
--         -- Crear un nuevo equipo en la tabla teams
--         INSERT INTO teams (team_id,team_name,meet_url,whatsapp_url,project_name,event_record_id,team_number)
--         VALUES (uuid_generate_v4(),team_name_v,null,null,null,null,team_counter )
--         RETURNING team_id INTO new_team_id;
--
--         -- Actualizar los registros para establecer el team_id del nuevo equipo
--         UPDATE event_records
--         SET team_id = new_team_id
--         WHERE schedule = scheduleNom
--           AND event_id = eventNum
--           AND number_team = team_counter;
