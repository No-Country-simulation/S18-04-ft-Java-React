...
public class SecurityConfig {
        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
                http
                                ...
                                .authorizeHttpRequests(authConfig -> {
                                        ...
                                        authConfig.requestMatchers(HttpMethod.GET, "/api/auth/logout")
                                                        .hasAnyRole("USER");
                                        authConfig.requestMatchers(HttpMethod.GET, "/api/auth/check-login")
                                                        .hasAnyRole("USER");
        ...
        public AccessDeniedHandler accessDeniedHandler() {
                return (request, response, accessDeniedException) -> {
                        ...
                        response.getWriter()
                                        .write("403 Forbidden: Acceso denegado." + accessDeniedException.getMessage());
        ...
        CorsConfigurationSource corsConfigurationSource() {
                ...
                configuration.setAllowedOrigins(List.of("http://localhost:3000", "https://no-country.up.railway.app",
                                "https://nocountry.up.railway.app", "http://localhost:8090", "*"));
